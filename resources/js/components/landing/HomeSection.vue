  ...
  <div class="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
    <div>
      ...
      <div class="flex flex-wrap gap-4">
        <Link
          :href="solutionsIndex()"
          class="bg-emerald-500 hover:bg-emerald-400 transition px-8 py-4 rounded-2xl font-semibold text-black shadow-2xl shadow-emerald-500/30 cursor-pointer block text-center"
        >
          Explore Solutions
        </Link>
